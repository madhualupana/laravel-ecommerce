    ...
    <div class="container mx-auto px-4 py-8">
        ...
        @else
            <div class="bg-white rounded-lg shadow-md p-8 text-center">
                ...
                <h3 class="mt-2 text-lg font-medium text-gray-900">No products found in this category</h3>
                <p class="mt-1 text-gray-500">Check back later or browse our other categories.</p>
                <div class="mt-6">
