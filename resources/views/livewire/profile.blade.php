            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Add this new wishlist link -->
    <a href="{{ route('wishlist') }}" class="group flex items-center px-4 py-3 bg-gray-50 hover:bg-indigo-50 rounded-lg transition-colors duration-200">
        ...
        <span class="ml-3 text-gray-700 group-hover:text-indigo-600 font-medium">My Wishlist</span>
    </a>
